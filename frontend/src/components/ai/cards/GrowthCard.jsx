  ...
  return (
    <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.28em] text-slate-400">Growth</p>
          <h3 className="text-lg font-semibold text-slate-900">Growth analysis</h3>
        </div>
      </div>
